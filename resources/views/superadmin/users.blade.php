                ...
                <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
                                        ...
                                        <input type='text' value='https://easychows.com/{{$user->slug}}' class='form-control bg-light-primary'/>
									</div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
								...
								<div id="kt_account_settings_profile_details" class="collapse show">
									...
									<form id="update_profile" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype='multipart/form-data' novalidate="novalidate">@csrf
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-bold fs-6"> Display Image</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
													<!--begin::Image input-->
													<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image:url('/public/profilePic/{{$rest->image ?? 'normal.png'}}')">
														<!--begin::Preview existing avatar-->
														<div class="image-input-wrapper w-125px h-125px" style="background-image: url('/public/profilePic/{{$rest->image ?? 'normal.png'}}')"></div>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" id='name' name="name" class="form-control form-control-lg form-control-solid" placeholder="Restaurant name" value="{{$user->name}}">
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" id='description' name="description" class="form-control form-control-lg form-control-solid" placeholder="Short Description" value="{{$user->description}}">
												<div class="fv-plugins-message-container invalid-feedback"></div></div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="tel" name="phone" id='phone'  value='{{$user->phone ?? ""}}' class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{$user->phone}}">
												<div class="fv-plugins-message-container invalid-feedback"></div></div>
												<!--end::Col-->
											</div>
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="tel" name="phone" id='email'  class="form-control form-control-lg form-control-solid" readonly placeholder="Email Address" value="{{$user->email}}">
												<div class="fv-plugins-message-container invalid-feedback"></div></div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<select name="school" id='school' aria-label="Select a school" data-control="select2" data-placeholder="Select a school..." class="form-select form-select-solid form-select-lg fw-bold select2-hidden-accessible" data-select2-id="select2-data-7-llbv" tabindex="-1" aria-hidden="true">
														<option value="{{$user->school ?? ''}}" data-select2-id="select2-data-9-1hiw">{{$user->school ?? 'Select School'}}</option>
