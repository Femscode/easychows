                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card card-flush">
                            <div class='card-header'>
                                Total Counts : {{ count($orders) }}

                                <form method='post' action='/check_today_vendor'>@csrf 
                                    ...
                                    <table style='width:100%' id='datatable'
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="">Vendor | Customer</th>
                                                <th class="text-end ">Total</th>
                                                <th class="text-end  sorting" aria-controls="kt_ecommerce_sales_table">
                                                    Date Added</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600" id='t_body'>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-gray-800 text-hover-primary fs-5 fw-bolder"> {{
                                                        $order->user->name ?? "null" }} | {{$order->name}}</p>

                                                </td>

                                                <td class="text-end pe-0">
                                                    <span class="fw-bolder">₦{{number_format($order->total_price +
                                                        $order->delivery_amount,2)}}</span>
                                                </td>
                                                <td class="text-end"
                                                    data-order="{{Date('d-m-Y', strtotime($order->created_at))}}">
                                                    <span class="fw-bolder">{{Date('d/m/Y',
                                                        strtotime($order->created_at))}}</span>
                                                </td>
                                                <td class="text-end"
                                                    data-order="{{Date('d/m/Y', strtotime($order->updated_at))}}">
                                                    <span class="fw-bolder">{{$order->location}}</span>
                                                </td>
                                                <td>{{ $order->mode ?? "web" }}</td>
                                                <td class="text-end">
