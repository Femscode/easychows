                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card card-flush">
                            <div class='card-header'>
                                <h1 class='mt-4'>Cashout Page</h1>
                                <h4>Total Counts : {{ $orders }}</h4>

                                <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Restaurant" />
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div style='overflow-x:auto;max-width: 100%'>
                                    <table style='width:100%' id='datatable kt_ecommerce_sales_table' 
                                        class="datatable table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <tbody class="fw-bold text-gray-600" id='t_body'>
                                            ...
                                            <tr>
                                               ...
                                               <td data-kt-ecommerce-order-filter="name">
                                                    {{ $user->name }}
                                               </td>
                                               <td>
                                                {{ $user->orders->where('created_at', '>=', now()->startOfWeek(Carbon\Carbon::SUNDAY))->count() }}   
                                            </td>

                                                <td class="text-end">

                                                    <a href='https://wa.me/234{{ substr($user->phone, 1) }}?text=Dear%20Vendor,%20%0A%0A*HERE%20IS%20YOUR%20CTTASTE%20BILL%20FOR%20THE%20WEEK:*%0A%0ATotal%20Orders:%20{{ $user->orders->where('created_at', '>=', now()->startOfWeek(Carbon\Carbon::SUNDAY))->count() }}%0ADiscounted%20Order:%20{{ number_format($user->orders->where('created_at', '>=', now()->startOfWeek(Carbon\Carbon::SUNDAY))->count() - (0.90 * $user->orders->where('created_at', '>=', now()->startOfWeek(Carbon\Carbon::SUNDAY))->count())) }}%0ATotal%20Amount%20To%20Be%20Paid:%20*NGN{{ number_format(50 * ceil(0.90 * $user->orders->where('created_at', '>=', now()->startOfWeek(Carbon\Carbon::SUNDAY))->count())) }}*%0A%0A*Account To Pay To:*%0AAccount No: 9058744473%0ABank: Moniepoint%0AName: CTHOSTEL Products & Services.'
                                                        style='background:#ebab21;color:#ffffff;font-weight:bold; padding: 10px; text-decoration:none; border-radius: 5px;'>Message</a>
