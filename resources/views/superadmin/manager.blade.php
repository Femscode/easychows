								...
								<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
									...
									<thead>
										...
										<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
											...
											<th style='display:none' class="text-end min-w-100px">Account</th>
											<th class="text-end min-w-100px">Total Count</th>
											<th style='display:none' class="text-end min-w-100px">Today Count</th>
										...
										<tr>
											...
											<td>
												<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
													<a>
														<div class="symbol-label fs-3 bg-light-warning text-warning">{{ ++$key }}</div>
													</a>
												</div>
											</td>
											<!--end::Checkbox-->
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div class="ms-5">
														<!--begin::Title-->
														<a class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$user->phone}}</a>
														<!--end::Title-->
													</div>
												</div>
											</td>
											...
											<!--end::Total=-->
											<!--begin::Date Added=-->
											<td style='display:none' class="text-end" data-order="2022-01-28">
											...
											<td class="text-end" data-order="2022-01-31">
												<span class="fw-bolder">{{count($user->orders)}}</span>
											</td>
											<td style='display:none' class="text-end" data-order="2022-01-31">
												<span class="fw-bolder">{{gmdate("H:m")}}</span>
											</td>
											<!--end::Date Modified=-->
											<!--begin::Action=-->
											<td class="text-end">
												<div class="card-toolbar">
													...
													<!--begin::Menu 3-->
														...
														<div class="btn btn-success btn-sm">
															<a href="vendor_order/{{$user->id}}" class="menu-link px-3">View Orders</a>
														</div>
