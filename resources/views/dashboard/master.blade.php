...
<head>
    ...
    <meta content="EasyChows" name="author">
    <title>EasyChows | Dashboard</title>
    <!-- Favicon icon-->
    ...
    <script src="{{url('cdn/jquery-3.6.0.js')}}" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="{{url('cdn/datatable.css')}}">
    
    <!-- jQuery -->
    <!-- DataTables JS -->
    <script src="{{url('cdn/datatable.js')}}"></script>
...
<body>
                            ...
                            <li class="dropdown ms-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-0">
                                    ...
                                    <div class="border-top px-5 py-3">
                                        <a href="/logout" onclick='return confirm("Are you sure you want to logout?");'>Log Out</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
    ...
    <script src="{{url('assets/js/vendors/chart.js')}}"></script>
